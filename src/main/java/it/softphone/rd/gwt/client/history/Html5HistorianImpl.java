		...
		$wnd
				.addEventListener(
						...
						function(event) {
							...
							that.@it.softphone.rd.gwt.client.history.Html5HistorianImpl::onPopState(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)(data, event.title, event.url);
