...
public class CommonPlaceHistoryHandler {
	...
	protected class DefaultHistoryHandler implements HistoryHandler {
		...
		public void goTo(Place place, boolean ignore) {
			CommonPlaceHistoryHandler.this.ignore = ignore;
			placeController.goTo(place);
	...
	protected static Logger log = Logger.getLogger(CommonPlaceHistoryHandler.class.getName());
	...
	public CommonPlaceHistoryHandler(PlaceHistoryMapper placeHistoryMapper, HistoryObserver historyObserver) {
	...
	protected HandlerRegistration bind() {
		...
		return new HandlerRegistration() {
			public void removeHandler() {
				CommonPlaceHistoryHandler.this.defaultPlace = Place.NOWHERE;
				CommonPlaceHistoryHandler.this.placeController = null;
